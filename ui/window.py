...
from PyQt6.QtWidgets import (
    QWidget, QLabel, QProgressBar, QVBoxLayout, QMenu, QApplication, 
    QGraphicsOpacityEffect, QInputDialog, QLineEdit, QPushButton, 
    QHBoxLayout, QFrame
)
from PyQt6.QtCore import (
    Qt, QPoint, QTimer, QPropertyAnimation, QEasingCurve, 
    QParallelAnimationGroup, QCoreApplication, QRectF, pyqtSignal, QSize
)
